...
var Utils = {
  ...
  Navbar = (function () {
    var e = document.querySelector("[data-navbar]"),
      ...
      n = {};
    function r() {
      App.get.scrollPosition() >= n.visibleOffset
        ? ((i.isVisible = !0), e.setAttribute(t.visible, ""))
        : ((i.isVisible = !1), e.removeAttribute(t.visible)),
  ...
  Clock = (function () {
    ...
    function n() {
      (t.dateFull = new Date()),
        (t.dateTime =
          String(t.dateFull.getHours()).padStart(2, "0") +
          ":" +
          String(t.dateFull.getMinutes()).padStart(2, "0")),
      ...
      (r.cursorX = Utils.lerp(r.cursorX, App.get.mouseX(), e.easing)),
        ...
        i.setAttribute(
          ...
          Utils.prefixCss(
            "transform",
            "translate3d(" +
              Utils.round(r.cursorX) +
              "px, " +
              Utils.round(r.cursorY) +
              "px, 0px)"
          )
        ),
    ...
    return {
      init: function () {
        Is.pointerFine &&
          ...
          (o.links = document.querySelectorAll(
